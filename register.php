...
$sql = 'INSERT INTO ' . $table_name . ' (id, month, item, amount, category, beneficiary, paid_on, paid_by, note, last_updated_on) VALUES  (NULL, :month, :item, :amount, :category, :beneficiary, :paid_on, :paid_by, :note, now())';
