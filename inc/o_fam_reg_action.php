...
$sql = 'INSERT INTO family(id, login_name, password, real_name, 0, is_admin, created_at, updated_at, suspended_until) VALUES(NULL, :login_name, :password, :real_name, now(), now(), 1970-01-01)';
